    ...
    <div className="mb-2 group/g">
      <div className="flex items-center w-full pr-2">
        <button
          ...
          className="flex-1 flex items-center gap-1 px-3 py-1 text-xs font-medium text-fg-faint hover:text-fg-muted uppercase tracking-wider min-w-0"
        >
        ...
        {onAddProject && (
          <button
            ...
            className="p-1 rounded text-fg-faint hover:text-fg hover:bg-elevated opacity-0 group-hover/g:opacity-100 transition-opacity"
          >
            <Plus size={12} />
          </button>
        )}
